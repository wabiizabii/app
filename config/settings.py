...
WORKSHEET_HEADERS = {
    ...
    SUPABASE_TABLE_PORTFOLIOS: [
        ...
        'ScaleUp_MinGainPercent', 'ScaleUp_RiskIncrementPercent',
    ...
    SUPABASE_TABLE_PLANNED_LOGS: [
        "LogID", "Timestamp", "PortfolioID", "PortfolioName", "Asset", "Mode",
        "Direction", "Risk %", "Fibo Level", "Entry", "SL", "TP", "Lot",
        "Risk $", "RR", "EntryTime", "Notes"
    ],

    SUPABASE_TABLE_ACTUAL_TRADES: [
        "Deal_ID", "PortfolioID", "PortfolioName", "Time_Deal", "Symbol_Deal",
        "Type_Deal", "Direction_Deal", "Volume_Deal", "Price_Deal", "Order_ID_Deal",
        "Commission_Deal", "Fee_Deal", "Swap_Deal", "Profit_Deal", "Balance_Deal",
        "Comment_Deal", "SourceFile", "ImportBatchID"
    ],

    SUPABASE_TABLE_ACTUAL_ORDERS: [
        "Order_ID_Ord", "PortfolioID", "PortfolioName", "Open_Time_Ord", "Symbol_Ord",
        "Type_Ord", "Volume_Ord_Raw", "Price_Ord", "S_L_Ord", "T_P_Ord",
        "Close_Time_Ord", "State_Ord", "Comment_Ord", "SourceFile", "ImportBatchID",
        "Volume_Ord"
    ],

    SUPABASE_TABLE_ACTUAL_POSITIONS: [
        "Position_ID", "PortfolioID", "PortfolioName", "Time_Pos", "Symbol_Pos",
        "Type_Pos", "Volume_Pos", "Price_Open_Pos", "S_L_Pos", "T_P_Pos",
        "Time_Close_Pos_Raw", "Price_Close_Pos", "Commission_Pos", "Swap_Pos",
        "Profit_Pos", "SourceFile", "ImportBatchID", "Time_Close_Pos", "Comment"
    ],

    SUPABASE_TABLE_STATEMENT_SUMMARIES: [
        "ImportBatchID", "Timestamp", "PortfolioID", "PortfolioName", "SourceFile",
        "ClientName", "Balance", "Equity", "Free_Margin", "Margin", "Floating_P_L",
        "Margin_Level", "Credit_Facility", "Deposit", "Withdrawal", "Gross_Profit",
        "Gross_Loss", "Total_Net_Profit", "Profit_Factor", "Recovery_Factor",
        "Expected_Payoff", "Sharpe_Ratio", "Balance_Drawdown", "Balance_Drawdown_Absolute",
        "Maximal_Drawdown_Value", "Maximal_Drawdown_Percent", "Balance_Drawdown_Relative_Percent",
        "Balance_Drawdown_Relative_Value", "Total_Trades", "Profit_Trades_Count",
        "Profit_Trades_Percent", "Loss_Trades_Count", "Loss_Trades_Percent",
        "Long_Trades_Count", "Long_Trades_Won_Percent", "Short_Trades_Count",
        "Short_Trades_Won_Percent", "Largest_Profit_Trade", "Average_Profit_Trade",
        "Largest_Loss_Trade", "Average_Loss_Trade", "Max_Consecutive_Wins_Count",
        "Max_Consecutive_Wins_Profit", "Maximal_Consecutive_Profit_Value",
        "Maximal_Consecutive_Profit_Count", "Max_Consecutive_Losses_Count",
        "Max_Consecutive_Losses_Profit", "Maximal_Consecutive_Loss_Value",
